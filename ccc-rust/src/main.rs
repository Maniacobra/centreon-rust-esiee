...
fn display_list(color_enabled: bool) {
    if color_enabled {
        ...
        println!("{} GetVersion", " ".repeat(4));
        println!("{} GetProcessStats", " ".repeat(4));
        println!("{} GetGenericStats", " ".repeat(4));
        println!("{} GetConflictManagerStats", " ".repeat(4));
        println!("{} GetNumModules", " ".repeat(4));
        println!("{} GetNumEndpoint", " ".repeat(4));
        println!("{} GetProcessingStats", " ".repeat(4));
        println!("{} SetSqlManagerStats{}", " ".repeat(4), "{SqlManagerStatsOptions}".green());
        println!("{} GetSqlManagerStats{}", " ".repeat(4), "{SqlConnection}".green());
        println!("{} GetMuxerStats{}", " ".repeat(4), "{GenericString}".green());
        println!("{} GetModulesStats{}", " ".repeat(4), "{GenericNameOrIndex}".green());
        println!("{} GetEndpointStats{}", " ".repeat(4), "{GenericNameOrIndex}".green());
        println!("{} RebuildRRDGraphs{}", " ".repeat(4), "{IndexIds}".green());
        println!("{} GetBa{}", " ".repeat(4), "{BaInfo}".green());
        println!("{} RemoveGraphs{}", " ".repeat(4), "{ToRemove}".green());
        println!("{} RemovePollers{}", " ".repeat(4), "{GenericNameOrIndex}".green());
        println!("{} GetLogInfo{}", " ".repeat(4), "{GenericString}".green());
        println!("{} SetLogLevel{}", " ".repeat(4), "{LogLevel}".green());
        println!("{} SetLogFlushPeriod{}", " ".repeat(4), "{LogFlushPeriod}".green());
    } else {
        ...
        println!("{} GetNumEndpoint", " ".repeat(4));
        println!("{} GetProcessingStats", " ".repeat(4));
        println!("{} SetSqlManagerStats{}", " ".repeat(4), "{SqlManagerStatsOptions}");
        println!("{} GetSqlManagerStats{}", " ".repeat(4), "{SqlConnection}");
        println!("{} GetMuxerStats{}", " ".repeat(4), "{GenericString}");
        println!("{} GetModulesStats{}", " ".repeat(4), "{GenericNameOrIndex}");
        println!("{} GetEndpointStats{}", " ".repeat(4), "{GenericNameOrIndex}");
        println!("{} RebuildRRDGraphs{}", " ".repeat(4), "{IndexIds}");
        println!("{} GetBa{}", " ".repeat(4), "{BaInfo}");
        println!("{} RemoveGraphs{}", " ".repeat(4), "{ToRemove}");
        println!("{} RemovePollers{}", " ".repeat(4), "{GenericNameOrIndex}");
        println!("{} GetLogInfo{}", " ".repeat(4), "{GenericString}");
        println!("{} SetLogLevel{}", " ".repeat(4), "{LogLevel}");
        println!("{} SetLogFlushPeriod{}", " ".repeat(4), "{LogFlushPeriod}");
    }
}
